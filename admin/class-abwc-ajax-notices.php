...
class ABWC_Ajax_Cart_notices {
	...
	public function new_setting_notice_1_2_0() {
		...
		$link = '<a href="' . admin_url( "options-general.php?page=abwc_ajaxified_settings" ) . '">' . __( "Settings", "abwc-ajax-cart-mod" ) . '</a>';
		?>
		<div data-dismiss="true" class="notice notice-success is-dismissible">
			<p><?php _e( '<b>Ajaxified Cart WooCommerce:</b> Have you checked our new ' . $link . ' page!', 'abwc-ajax-cart-mod' ); ?></p>
		</div>
		<?php
	}
